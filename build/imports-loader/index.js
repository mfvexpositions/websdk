// TODO: Maybe make a pull request
...
module.exports = function(content, sourceMap) {
    ...
    Object.keys(query).forEach(function(name) {
        ...
        } else if(typeof query[name] == "string" && query[name].substr(0, 1) == ":") {
          value = query[name].substr(1).split(':');
        } else {
            var mod = name;
        ...
        if(name === "closure"){
          imports.push("module.exports = function(){(function(" + value.join(",") + ") {");
          postfixes.unshift("}.apply(this, arguments))};");
        }
        else if(name === "this") {
